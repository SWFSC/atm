...
atm::extract_ctd_header(header.filename.ctd, type = "CTD")
atm::extract_ctd_cast(cast.filename.ctd, type = "CTD")
...
atm::extract_ctd_header(header.filename.uctd, type = "UCTD")
atm::extract_ctd_cast(cast.filename.uctd, type = "UCTD")
